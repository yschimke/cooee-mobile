...
import ee.coo.mobile.ui.CooeeApp
import dagger.hilt.android.AndroidEntryPoint
import ee.coo.wear.compose.util.JankPrinter

@AndroidEntryPoint
class CooeeActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CooeeApp(navController = navController)
